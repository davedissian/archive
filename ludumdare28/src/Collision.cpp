...
public:
    ...
    sf::Uint8 GetPixel(const sf::Uint8* mask, const sf::Texture* tex, unsigned int x,
                       unsigned int y)
    {
    ...
    if (Object1.getGlobalBounds().intersects(Object2.getGlobalBounds(), Intersection))
    {
        ...
        for (int i = Intersection.left; i < Intersection.left + Intersection.width; i++)
        {
            for (int j = Intersection.top; j < Intersection.top + Intersection.height; j++)
            {
                ...
                if (o1v.x > 0 && o1v.y > 0 && o2v.x > 0 && o2v.y > 0 && o1v.x < O1SubRect.width &&
                    o1v.y < O1SubRect.height && o2v.x < O2SubRect.width && o2v.y < O2SubRect.height)
                {
...
{
public:
    OrientedBoundingBox(const sf::Sprite& Object)    // Calculate the four points of the OBB from a
...
bool BoundingBoxTest(const sf::Sprite& Object1, const sf::Sprite& Object2)
{
    ...
    for (int i = 0; i < 4; i++)    // For each axis...
    {
        ...
        // If this is not the case, the Seperating Axis Theorem states that there can be no
