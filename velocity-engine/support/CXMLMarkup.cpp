// CXMLMarkup.cpp: implementation of the CXMLMarkup class.
//
// Markup Release 11.2
// Copyright (C) 2009 First Objective Software, Inc. All rights reserved
// Go to www.firstobject.com for the latest CXMLMarkup and EDOM documentation
// Use in commercial applications requires written permission
// This software is provided "as is", with no warranty.
//
#include <stdio.h>
#include "CXMLMarkup.h"
...
void x_AddResult( MCD_STR& strResult, MCD_CSTR pszID, MCD_CSTR pszVal = NULL, int nResultCode = 0, int n = -1, int n2 = -1 )
{
	...
	{
		// Use a temporary CXMLMarkup object but keep strResult in a string to minimize memory footprint
...
struct TokenPos
{
	...
	{
		int nLen = Length();
		if ( m_nTokenFlags & CXMLMarkup::MDF_IGNORECASE )
...
// In file mode the file stays open between CXMLMarkup calls and is stored in m_pFilePos
//
struct FilePos
{
	FilePos()
...
bool PathPos::AttribPredicateMatch( TokenPos& token )
{
	...
	if ( token.FindAttrib(GetPtr()) )
	{
		...
		if ( GetChar() == '=' )
		{
			...
			MCD_STR strAttribValue = CXMLMarkup::UnescapeText( token.GetTokenPtr(), token.Length() );
...
MCD_STR CXMLMarkup::UnescapeText( MCD_CSTR szText, int nTextLength /*=-1*/ )
{
...
//////////////////////////////////////////////////////////////////////
// CXMLMarkup private methods
//
void CXMLMarkup::x_InitMarkup()
{
	// Only called from CXMLMarkup constructors
	m_pFilePos = NULL;
