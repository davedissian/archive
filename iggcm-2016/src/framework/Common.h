...
#else
    #define COLOUR_INFO
    #define COLOUR_WARNING
    #define COLOUR_ERROR
#endif

inline std::ostream& __INFOSTREAM()
{
    COLOUR_INFO
    return cout << "[info] ";
}

inline std::ostream& __WARNINGSTREAM()
{
    COLOUR_WARNING
    return cerr << "[warning] ";
}

inline std::ostream& __ERRORSTREAM()
{
    COLOUR_ERROR
    return cerr << "[error] ";
}

#define INFO    __INFOSTREAM()
#define WARNING __WARNINGSTREAM()
#define ERROR   __ERRORSTREAM()
